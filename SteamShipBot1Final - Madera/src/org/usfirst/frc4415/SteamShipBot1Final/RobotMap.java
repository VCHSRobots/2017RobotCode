...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveTrainQuadratureEncoder1 = new Encoder(7, 8, false, EncodingType.k4X);
        ...
        climberQuadratureEncoder1 = new Encoder(3, 4, false, EncodingType.k4X);
        ...
        gearHandlergearHandlerSolenoid = new DoubleSolenoid(0, 6, 7);
        ...
        cameraSystemLED = new DigitalOutput(12);
        LiveWindow.addActuator("Camera System", "LED", cameraSystemLED);
        
        fuelTankDoubleSolenoid = new DoubleSolenoid(0, 4, 5);
