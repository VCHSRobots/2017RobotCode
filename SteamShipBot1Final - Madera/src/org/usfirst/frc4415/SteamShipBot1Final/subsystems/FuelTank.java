...
public class FuelTank extends Subsystem {
	...
	private boolean m_deployState = false;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    private final DoubleSolenoid doubleSolenoid = RobotMap.fuelTankDoubleSolenoid;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new FuelTankDefault());
