...
public class Robot extends IterativeRobot {
    ...
    private void commonDashboardReport(){   
		...
		SmartDashboard.putNumber("Drive Encoder", driveTrain.getEncoderValue());
		SmartDashboard.putNumber("IR Sensor", driveTrain.getIR());
		
		SmartDashboard.putNumber("Camera X Value" , cameraSystem.getX());
		SmartDashboard.putNumber("Camera Y Value", cameraSystem.getY());
		//SmartDashboard.putNumber("POV", oi.getShooterJoystick().getPOV());
		
		//SmartDashboard.putBoolean("Shooter Enabled", shooter.getShooterToggle());
		SmartDashboard.putNumber("Shooter Encoder", shooter.getEncoderSpeed());
		//SmartDashboard.putNumber("Shooter Output Voltage", shooter.getOutputVoltage());
		//SmartDashboard.putNumber("SetPoint Value", shooter.getSetpoint());
		
		SmartDashboard.putBoolean("Pin 1", cameraSystem.getPin1());
		SmartDashboard.putBoolean("Pin 2", cameraSystem.getPin2());
		SmartDashboard.putBoolean("Pin 3", cameraSystem.getPin3());
		SmartDashboard.putBoolean("Pin 4", cameraSystem.getPin4());

		if (mqtt != null) {
			SmartDashboard.putNumber("MqTT Received", mqtt.getCountReceived());
			SmartDashboard.putNumber("MqTT Sent",     mqtt.getCountSent());
			SmartDashboard.putNumber("MqTT Save Msg", mqtt.getCountSavedMsgs());
			SmartDashboard.putNumber("MqTT Dups",     mqtt.getCountDups());
    ...
    public void disabledPeriodic() {
		...
		autoParams.loadData();  // Do this a lot before Auto Mode.
    ...
    public void teleopPeriodic() {
    	...
    	autoParams.loadData();  // No need to do this here, but its nice to keep dashboard updated.
    	Scheduler.getInstance().run();
    	commonDashboardReport();
    }
