...
public class RobotMap {
    ...
    public static DigitalOutput lEDPinsDigitalOutput6;
    public static DigitalOutput lEDPinsDigitalOutput7;
    public static DigitalOutput lEDPinsDigitalOutput8;
    public static DigitalOutput lEDPinsDigitalOutput9;
    ...
    public static void init() {
        ...
        lEDPinsDigitalOutput6 = new DigitalOutput(8);
        LiveWindow.addActuator("LED Pins", "Digital Output 6", lEDPinsDigitalOutput6);
        
        lEDPinsDigitalOutput7 = new DigitalOutput(9);
        LiveWindow.addActuator("LED Pins", "Digital Output 7", lEDPinsDigitalOutput7);
        
        lEDPinsDigitalOutput8 = new DigitalOutput(10);
        LiveWindow.addActuator("LED Pins", "Digital Output 8", lEDPinsDigitalOutput8);
        
        lEDPinsDigitalOutput9 = new DigitalOutput(11);
        LiveWindow.addActuator("LED Pins", "Digital Output 9", lEDPinsDigitalOutput9);
