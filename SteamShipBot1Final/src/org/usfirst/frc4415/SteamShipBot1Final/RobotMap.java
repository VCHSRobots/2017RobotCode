...
public class RobotMap {
    ...
    public static DigitalOutput lEDPinsDigitalOutput1;
    public static DigitalOutput lEDPinsDigitalOutput2;
    public static DigitalOutput lEDPinsDigitalOutput3;
    public static DigitalOutput lEDPinsDigitalOutput4;
    ...
    public static void init() {
        ...
        lEDPinsDigitalOutput1 = new DigitalOutput(8);
        LiveWindow.addActuator("LED Pins", "Digital Output 1", lEDPinsDigitalOutput1);
        
        lEDPinsDigitalOutput2 = new DigitalOutput(9);
        LiveWindow.addActuator("LED Pins", "Digital Output 2", lEDPinsDigitalOutput2);
        
        lEDPinsDigitalOutput3 = new DigitalOutput(10);
        LiveWindow.addActuator("LED Pins", "Digital Output 3", lEDPinsDigitalOutput3);
        
        lEDPinsDigitalOutput4 = new DigitalOutput(11);
        LiveWindow.addActuator("LED Pins", "Digital Output 4", lEDPinsDigitalOutput4);
