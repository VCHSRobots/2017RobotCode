...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Drive Train Default", new DriveTrainDefault());
        SmartDashboard.putData("Drive Train Toggle Drive", new DriveTrainToggleDrive());
        SmartDashboard.putData("Drive Train Toggle Direction", new DriveTrainToggleDirection());
        SmartDashboard.putData("Drive Train Toggle Gyro", new DriveTrainToggleGyro());
        SmartDashboard.putData("Shooter Default", new ShooterDefault());
        SmartDashboard.putData("Shooter Toggle Shooter", new ShooterToggleShooter());
        SmartDashboard.putData("Turret Auto Aim", new TurretAutoAim());
        SmartDashboard.putData("Camera System Cam1", new CameraSystemCam1());
        SmartDashboard.putData("Camera System Cam2", new CameraSystemCam2());
        SmartDashboard.putData("Camera System Cam3", new CameraSystemCam3());
        SmartDashboard.putData("Camera System Cam4", new CameraSystemCam4());
        SmartDashboard.putData("Climber Default", new ClimberDefault());
        SmartDashboard.putData("Climber Forward", new ClimberForward());
        SmartDashboard.putData("Climber Backward", new ClimberBackward());
        SmartDashboard.putData("Gear Handler Default", new GearHandlerDefault());
        SmartDashboard.putData("Gear Handler Toggle Gear Handler", new GearHandlerToggleGearHandler());
        SmartDashboard.putData("Blender Default", new BlenderDefault());
        SmartDashboard.putData("Drive Train Strafe Left", new DriveTrainStrafeLeft());
        SmartDashboard.putData("Drive Train Strafe Right", new DriveTrainStrafeRight());
        SmartDashboard.putData("Turret Default", new TurretDefault());
        SmartDashboard.putData("Turret Reset", new TurretReset());
        SmartDashboard.putData("Gear Handler Toggle Gear Grip", new GearHandlerToggleGearGrip());
        SmartDashboard.putData("Camera System Default", new CameraSystemDefault());
        SmartDashboard.putData("Fuel Tank Default", new FuelTankDefault());
        SmartDashboard.putData("Fuel Tank Toggle Wing", new FuelTankToggleWing());
        SmartDashboard.putData("Auto Move Straight", new AutoMoveStraight());
        SmartDashboard.putData("Auto Shoot Blue", new AutoShootBlue());
        SmartDashboard.putData("Auto Shoot Red", new AutoShootRed());
