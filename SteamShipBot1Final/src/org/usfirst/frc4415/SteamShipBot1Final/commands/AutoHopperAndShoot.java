...
public class AutoHopperAndShoot extends Command {
    ...
    protected void initialize() {
    	...
    	autoStage = 0;
    	Robot.targetReportMonitor.selectTarget(1);
    	...
    	autoProgram.add(new PIDRobotDriveMove(
    			robotDrive, 80*inchesToTicks, 10, 5000));
    	...
    	if(Robot.autoParams.getSide().equals("blue")){
        	autoProgram.add(new PIDRobotDriveRotate(
        			robotDrive, 90, true, 5, 3000));
        	} else {
        		autoProgram.add(new PIDRobotDriveRotate(
            			robotDrive, -90, true, 5, 2000));
        	}
    	...
    	// move to hopper
    	autoProgram.add(new PIDRobotDriveMove(
    			robotDrive, -42*inchesToTicks, 10, 1000));
    	...
    	// center turret
    	// pause
    	autoProgram.add(new TimeDelay(1000));
    	
    	// back up from hopper
    	autoProgram.add(new PIDRobotDriveMove(
    			robotDrive, 24*inchesToTicks, 10, 5000));
    ...
    protected void execute() {
	    if(autoStage < autoProgram.size()){
	    	...
	    	if(autoStage==5 && autoProgram.get(autoStage).isDone()){
	    		...
	    		Robot.shooter.setSetpoint(1040);
	    		Robot.blender.set(Robot.tableReader.get("blender", -.75));
	    	}
	    	...
	    	if(autoStage==9 && autoProgram.get(autoStage).isDone()){
	    		Robot.target.off();
	    		Robot.turret.turn(0);
	    	}
