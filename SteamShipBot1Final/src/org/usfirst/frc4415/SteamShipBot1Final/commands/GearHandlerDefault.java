 ...
 *
 */
public class GearHandlerDefault extends Command {
    ...
    protected void execute() {
    	...
    	SmartDashboard.putBoolean("Gear Handler", Robot.gearHandler.getToggleHandler());
    	SmartDashboard.putBoolean("Gear Grip", Robot.gearHandler.getToggleGear());
